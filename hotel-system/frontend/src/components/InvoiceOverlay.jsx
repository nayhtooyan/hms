...
function InvoiceSheet({ reservationId }) {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-32 bg-white rounded-lg">
  ...
  if (error || !data) {
    return <div className="text-center py-32 bg-white rounded-lg text-red-500">{error || t("noData")}</div>;
  }
