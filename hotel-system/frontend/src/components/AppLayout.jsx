...
import {
  ...
  Users, Settings, FolderCode, Menu, LogOut,
  BarChart3, HardDrive, Birdhouse, Package
} from "lucide-react";
...
const navItems = [
  ...
  { to: "/inventory", labelKey: "inventory", icon: Package, roles: ["admin", "manager", "reception", "cleaner", "maintenance"] },
...
export default function AppLayout() {
  ...
  const getPageTitle = () => {
    ...
    const currentNav = navItems.find((i) => location.pathname === i.to || location.pathname.startsWith(i.to + "/"));
